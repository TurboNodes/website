...
const SOCIALS = [
  {
    href: "https://github.com/TurboNode/Turbo",
...
export function SiteFooter({ theme = "dark" }: SiteFooterProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-none absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent to-transparent",
          isLight ? "via-orange-500/20" : "via-orange-500/15",
        )}
      />
